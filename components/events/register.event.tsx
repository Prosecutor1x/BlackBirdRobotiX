...
const Demo = () => {
    ...
    return (
        <div className="flex justify-center items-center space-x-60  bg-[#E4E5E7] ">
            <div
                className="text-[#EDA822] border shadow-[2px_3px_2px_2px_#EDA822] p-4 rounded-lg  my-5 bg-white -mt-7"
                id="book"
            >
                {popup == 3 ? (
            ...
            <div>
                ...
                <p className=" w-96 font-bold ">Scratch Contest unites participants of all continents. Scratch contest brings an opportunity for al to showcase
                    creative and innovative skills.</p>
                <p className=" w-96 font-bold mt-2">  Scratch is  free programming
                    environments designed to engage students in creative learning
                    experience. The Scratch contest is not affiliated with scratch or scratch foundation.</p>
            </div>
        </div>
    );
};
