  ...
  return (
    <div>
      <div className="lg:flex lg:min-h-screen justify-center items-center bg-white px-9 gap-20">
        <div className="lg:w-3/5 relative  flex-col justify-center items-center">
           <img src="/logo.png" className="absolute z-20  top-1/2  rounded-xl h-72  left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
          <ImageCarouselHero />
        </div>
